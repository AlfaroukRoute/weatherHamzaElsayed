...
( async function currentcity(){
    var res = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=7f6f7f23bb6840e0ac1220902220511&q=alexandria&days=5&aqi=yes&`)
...
document.getElementById("current").innerHTML =curdata;
 ...
 async function city(city){
    var res = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=7f6f7f23bb6840e0ac1220902220511&q=${city}&days=5&aqi=yes&`)
 var final = await res.json();
( function display (){ 
    var curdata = ``
     curdata += `    
...
document.getElementById("current").innerHTML =curdata;
 ...
 async function timeline(city){
    var res = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=7f6f7f23bb6840e0ac1220902220511&q=${city}&days=6&aqi=yes&`)
 var final = await res.json();
 console.log(final.forecast.forecastday[1].day);
( function display (){ 
    var curdata = ``
...
( async function currenttimeline(){
    var res = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=7f6f7f23bb6840e0ac1220902220511&q=alexandria&days=6&aqi=yes&`)
 var final = await res.json();
( function display (){ 
    var curdata = ``
     curdata += `  <div class="col-sm-12 col-md-3 col-lg">
...
( async function currentHighlights(){
    var res = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=7f6f7f23bb6840e0ac1220902220511&q=alexandria&days=6&aqi=yes&`)
 var final = await res.json();
 console.log(final.forecast.forecastday[0].hour);
( function display (){ 
    var curdata = ``
...
(async function currentHourly(){
    var res = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=7f6f7f23bb6840e0ac1220902220511&q=alexandria&days=6&aqi=yes&`)
 var final = await res.json();
var w = Array.of(final.forecast.forecastday[0].hour) 
var curdata = ``
for( var i =0 ; i<w[0].length ; i++){
     curdata += `
     <tr >
     <td class = "pb-4">${final.forecast.forecastday[0].hour[i].time}</td>
     <td class="pt-0 pb-4">
     <img src="     ${final.forecast.forecastday[0].hour[i].condition.icon}" alt="">
     </td>
     <td class = "pb-4">${final.forecast.forecastday[0].hour[i].temp_c}°</td>
     <td class = "pb-4">${final.forecast.forecastday[0].hour[i].chance_of_rain}%</td>
     <td class = "pb-4">${final.forecast.forecastday[0].hour[i].wind_kph}</td>
     </tr>
     `

}
document.getElementById("tdata").innerHTML =curdata;   

})();

async function cityHourly(city){
    var res = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=7f6f7f23bb6840e0ac1220902220511&q=${city}&days=6&aqi=yes&`)
 var final = await res.json();
var w = Array.of(final.forecast.forecastday[0].hour) 
var curdata = ``
